...
public class HttpAddNewTiktokEvent extends AsyncTask<String, Void, String> {

    HttpPost httppost;
    DefaultHttpClient httpclient;
    String URL = Constants.baseURL + "tiktokEvents.php";
    ...
    protected String doInBackground(String... params) {
        ...
        nameValuePairs.add(new BasicNameValuePair("function", "newAlarmRunEvent"));
