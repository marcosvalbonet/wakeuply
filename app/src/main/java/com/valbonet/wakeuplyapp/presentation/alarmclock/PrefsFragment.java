...
public class PrefsFragment extends PreferenceFragmentCompat implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findPreference(getString(R.string.settings_default_alarm_key)).
    ...
    public boolean onPreferenceClick(Preference preference) {
        if (preference.getKey().equalsIgnoreCase(getString(
            ...
            String url = "http://www.wakeuply.com";
        ...
        if (preference.getKey().equalsIgnoreCase(getString(
                R.string.settings_default_alarm_key))) {
            Intent alarm_settings = new Intent(getActivity(),
